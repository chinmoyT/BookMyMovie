...
import { newBooking, getMovieDetails } from '../api/api';
const Booking = () => {
                ...
                <Box width={'50%'} paddingTop={3}>
                    <form onSubmit={handleSubmit}>
                        <Box 
                            ...
                            <TextField value={inputs.seatNumber} onChange={handleChange} name='setNumber' type={'number'} margin='normal' 
                            variant='standard'/>
                            <FormLabel>Booking Date</FormLabel>
                            <TextField value={inputs.date} onChange={handleChange} name='date' type={'date'} margin='normal' 
                            variant='standard'/>
